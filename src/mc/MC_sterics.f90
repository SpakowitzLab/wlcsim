...
!--------------------------------------------------------------
subroutine MC_sterics(collisions,IB1,IB2,IT1,IT2,MCTYPE,forward,left,right,nn,neighbors,distances)
...
!     call findNeighbors(bin,wlc_RP(:,i),radius,R,WLC_P__NT,maxN,neighbors,distances,nn)
!     !print*, 'start'
!     !print*, nn, i
...
! ! add back all moved beads to original location
! do i = left, right
!     print* ,'here THREE'
!     call removeBead(bin,R(:,i),i)
