...
subroutine MC_superReptationMulti(wlc_p,R,U,RP,UP,AB,ABP,IP,IT1,IT2,IB1,IB2&
                  ,rand_stat,forward)
...
integer, intent(in) :: AB(WLC_P__NT)  ! Current chemical identity
integer, intent(out) :: ABP(WLC_P__NT)  ! Proposed chemical identity
