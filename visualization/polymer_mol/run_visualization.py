...
import os
baseNames={'../../':60} # splicify last savepoint (or savepoint you wish to view
kwargs ={}
import os
for baseName in baseNames.keys():
    savept_max = baseNames[baseName]
    for savept in [savept_max]: # or list savepoints you wish to view
        for rep in [6]: # list replicas you wish to view
            if True:
                suffix = "v"+str(rep)
            else:
                suffix = ""
